        ...
        <div className="main-wrap-content">
            <section className="parent">
                <div className="main-wrapper">
                    <h2 className="text-center sub-header">Help us improve SSP Pro Wallet</h2>
                    ...
                    <h4 className='text-center'>SSP Coin will...</h4>
                </div>
                <div className="check-list">
                    <ul>
                        ...
                        <li>
                            <span  className="colr-change"><i className="fa fa-times" aria-hidden="true"></i></span>A <b>Never</b> collect information we don’t need to provide the service (such as keys, addresses, transaction hashes, or balances)
                        </li>
                        <li>
                            <span className="colr-change"><i className="fa fa-times" aria-hidden="true"></i></span> <b>Never</b> collect your full IP address*
                        </li>
                        <li>
                            <span className="colr-change"><i className="fa fa-times" aria-hidden="true"></i></span><b>Never</b> sell data. Ever!
                        </li>

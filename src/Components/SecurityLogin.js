    ...
    <ul className="progressbar">
        ...
        <li className="bar">Create password</li>
                ...
                <div className="row">
                   ...
                   <input className="form-control" placeholder="username" onChange={getUserPhrases} type="text" id="username" />
                   </div>
                   <div className="col-lg-1 p-space">
                   <svg width="45" height="36" class="ft-green-tick user-verified" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" aria-hidden="true">
                        ...
                        <div className="row">
                            <div className="col-lg-12" >
                                <div className="center">
                                    <Link to="/secure-wallet" className="button-1 center" onClick={loginWithPhase} disabled type="button">
